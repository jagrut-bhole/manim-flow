    ...
    return (
        <div className="bg-blue-50 border-l-4 border-black p-4 mb-6">
            <div className="flex">
                ...
                <div className="ml-3">
                    <h3 className="text-sm font-medium text-black">What Can Be Animated</h3>
                    <div className="mt-2 text-sm text-green-600">
                        <p className="mb-2">
                            This creates <strong>educational mathematical animations</strong> using
                            Manim. Best for:
                        </p>
                        ...
                        <p className=" text-red-500 mt-3 font-medium">⚠️ Cannot Generate:</p>
                        ...
                        <p className="mt-3 text-xs text-black">
                            ...
                            something cool&quot;, try &quot;show a rotating square that changes
