        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
              ...
              <span
                className={cn(
                  "bg-clip-text text-transparent bg-linear-to-r from-cyan-300 via-white/90 to-indigo-300 ",
                )}
              >
                {title2}
              </span>
          ...
          >
            <Button
              ...
              className="px-8 py-7 cursor-pointer bg-white/10 hover:bg-white/20 text-white font-semibold rounded-xl border border-white/10 transition-all backdrop-blur-sm"
            >
              Get Started
            </Button>
          </motion.div>
