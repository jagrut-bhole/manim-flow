...
export const PLANS = [
    {
        ...
        features: ["30 credits per month", "480p video quality"],
    ...
    },
    {
        ...
        badge: "Coming Soon",
        features: ["60 credits per month", "720p & 1080p video quality"],
        cta: "Get Pro",
        available: true,
    },
    {
        ...
        badge: "Popular",
        features: ["30 instant credits", "High video quality", "Never expires"],
        cta: "Buy Credits",
        available: true,
    },
];
