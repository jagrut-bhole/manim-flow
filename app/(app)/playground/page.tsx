    ...
    const handleRender = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                throw new Error(response.data.message || "Failed to start rendering");
            }
        } catch (error: any) {
            console.error("Playground render error:", error);
            const errorMsg = error.response?.data?.message || "Failed to start rendering.";
            ...
            <main className="pt-20 pb-8 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-neutral-400">Write and test your Manim code here</p>
                    </div>
