...
export default function DashboardPage() {
    ...
    const [selectedModel, setSelectedModel] = useState<AIModel>(AIModel.GROQ_OLLAMA);
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const provider = selectedModel === AIModel.GOOGLE_GEMINI ? "gemini" : "groq";
            ...
            const errorMsg =
                error.response?.data?.message || "An error occurred while generating code";
            setError(errorMsg);
            toast.error(errorMsg);
                ...
                <AnimatePresence mode="wait">
                    {!isSubmitted ? (
                        ...
                        >
                            ...
                            <motion.div layoutId="prompt-container" className="w-full max-w-4xl">
                                <PromptInput
                                    value={inputText}
