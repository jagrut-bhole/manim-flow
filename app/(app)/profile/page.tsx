...
const CreationCard = ({ animation, index }: { animation: Animation; index: number }) => {
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <div className="flex items-center justify-between mb-8">
                            <div>
                                <h2 className="text-2xl font-bold text-white mb-2">My Creations</h2>
                                <p className="text-neutral-400">Your generated Manim animations</p>
                            </div>
